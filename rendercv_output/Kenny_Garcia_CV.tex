...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Kenny Garcia - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{Bachelor of Science}}{
            Sept 2023 – Dec 2026
        }
            \textbf{California State University Fullerton}, Computer Science
            \begin{highlights}
    ...
    \section{Experience}
        ...
        Nov 2024 – present
            ...
            \textbf{Coding Minds Academey}, Programming Instructor
            \begin{highlights}
                ...
                \item Enhanced student engagement and understanding by teaching coding concepts in Python, JavaScript, and Scratch, increasing class satisfaction scores by 20\% (Y), using interactive coding exercises and real-world applications
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C++, Python, JavaScript, x86 Assembly
        \end{onecolentry}
